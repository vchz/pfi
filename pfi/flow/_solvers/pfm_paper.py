"""Flow-matching solvers used for the PFM paper setup."""
...
from ..interpolants import ChebyshevInterpolant, select_best_lambda
...
def FM_(
    ...
    pbar = tqdm(range(n_epochs), desc="pfm_paper", dynamic_ncols=True, disable=not verbose)
    for epoch in pbar:
        optimizer.zero_grad()
...
__all__ = ["FM_", "compute_conditional_distributions"]
